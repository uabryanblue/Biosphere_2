...
The sensor names are E8D2, 2848, 672E, 0035. Groups of 4 graphs, one set for each THP sensor, are grouped into 2x2 grids. 
...
The calibration test show that all four THP sensors perform fairly well, with some of the deviation attributed to the original data anomaly of higher temperatures and lower humidity. There was relatively little data collected for this event compared to the rest of the normal data range. It may be interesting to run this analysis on the data with values that exclude this sudden RH drop.
