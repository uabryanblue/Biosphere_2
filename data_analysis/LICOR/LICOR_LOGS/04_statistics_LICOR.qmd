...
Graphs to visually check if the daily averages are normal.
...
The orignal Treatment data is not normal. There is a drastic improvement in the p-val when the log() transformation is applied, which shows the data is normal.  
**Treatment**  
...
The p-value = 2.368e-07 which is less than alpha = .05, t = -8.1264 does not fall in the 95% confidence interval [ -3.571281 -2.101800]. We reject the null hypothesis.  
