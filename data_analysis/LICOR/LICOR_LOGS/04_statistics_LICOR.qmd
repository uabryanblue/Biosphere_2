...
# original
n1plot_original <- normal_plot(finaldata, "Treatment", VARNAME, 
                      paste("Original: Elevation ", ELEVATION, ": \nTreatment - ", VARNAME, sep = ''))
# n1plot_original
# new
n1plot <- normal_plot(newfinaldata, "Treatment", VARNAME, 
                      paste("Wrangled: Elevation ", ELEVATION, ": \nTreatment - ", VARNAME, sep = ''))
# n1plot

# original
n2plot_original <- normal_plot(finaldata, "Control", VARNAME, 
                      paste("Original: Elevation ", ELEVATION, ": \nControl - ", VARNAME, sep = ''))
# n2plot_original
# new
n2plot <- normal_plot(newfinaldata, "Control", VARNAME, 
                     paste("Wrangled: Elevation ", ELEVATION, ": \nControl - ", VARNAME,  sep = ''))
# n2plot

# original
n3plot_original <- normal_plot(finaldata, "Reference", VARNAME, 
                      paste("Original: Elevation ", ELEVATION, ": \nReference - ", VARNAME, sep = ''))
# n3plot_original

n3plot <- normal_plot(newfinaldata, "Reference", VARNAME, 
                      paste("Wrangled: Elevation ", ELEVATION, ": \nReference - ", VARNAME, sep = ''))
# n3plot
...
n1plot <- normal_plot(TreatContRef, "Treatment", "gm",
                      paste("Elevation ", ELEVATION, ": Treatment - Daily Mean ", VARNAME, sep = ''))
n1plot

n2plot <- normal_plot(TreatContRef, "Control", "gm",
                      paste("Elevation ", ELEVATION, ": Control - Daily Mean ", VARNAME, sep = ''))
n2plot

n3plot <- normal_plot(TreatContRef, "Reference", "gm",
                      paste("Elevation ", ELEVATION, ": Reference - Daily Mean ", VARNAME, sep = ''))
n3plot
