...
VARNAME <- "GasEx_gsw" # this the column name in finaldata where the group and variable are combined
...
t1 <- ggplot(tdata, aes(x = tdata[[VARNAME]])) +
  ...
  scale_y_continuous(limits = c(0.0, 65)) # TODO change the scale of data values?
