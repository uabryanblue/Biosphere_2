...
write_csv(groupsdf, "data_cleaned/test_licor_data_cleaned.txt", append = TRUE, col_names = FALSE)
write_csv(unitsdf, "data_cleaned/test_licor_data_cleaned.txt", append = TRUE, col_names = FALSE)
write_csv(varsdf, "data_cleaned/test_licor_data_cleaned.txt", append = TRUE, col_names = FALSE)
write_csv(valuesdf, "data_cleaned/test_licor_data_cleaned.txt", append = TRUE, col_names = FALSE)
write_csv(valuesdf, "data_cleaned/test_licor_data_cleaned.txt", append = TRUE, col_names = FALSE)
...
write_csv(final_data, "data_cleaned/test_licor_selected_data.txt", append = FALSE, col_names = FALSE)
