...
write_csv(cleandf, here(paste(DATAUSER,"combined_selected_log_data.csv", sep = "")), append = FALSE, col_names = TRUE)

write_csv(cleandf[,1:6], here(paste(DATAUSER,"REMOVE_PREFIX_THEN_EDIT_leaf_identification.csv", sep = "")), append = FALSE, col_names = TRUE)
