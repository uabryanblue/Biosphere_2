...
# colmun names with ".y" are kept
# names(newdf)[names(newdf)=="Data_plant_id.x"] <- "Data_plant_id"
# names(newdf)[names(newdf)=="Data_leaftype.x"] <- "Data_leaftype"
# names(newdf)[names(newdf)=="Data_remarks.x"] <- "Data_remarks"
# # column names with ".x" are removed as they do not contain data
