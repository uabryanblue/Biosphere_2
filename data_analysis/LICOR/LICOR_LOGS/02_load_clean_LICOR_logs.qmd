...
`JOINED_final_raw_data.csv` is the joined values from the new data set and the previous leaf_identification.csv file. This allows prevous edits to remain and any NA values reviewed to have their `Data_plant_id, Data_leaftype` assigned.
...
leafjoindf <- rename(leafjoindf,c("Data_remarks" = "Data_remarks.y", "Data_plant_id" = "Data_plant_id.y", "Data_leaftype" = "Data_leaftype.y"))
...
write_csv(leafjoindf, here(DATAUSER, "input", "JOINED_final_raw_data.csv"), 
          append = FALSE, 
          col_names = TRUE)
...
# join causes duplication of column names
newdf <- rename(newdf,c("Data_remarks" = "Data_remarks.x", "Data_plant_id" = "Data_plant_id.x", "Data_leaftype" = "Data_leaftype.x"))
# colmun names with ".x" are kept
# column names with ".y" are removed as they do not contain data
