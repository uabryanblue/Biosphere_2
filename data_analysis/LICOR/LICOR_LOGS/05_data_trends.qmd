...
finaldata <- read_and_clean_data(fname)
...
# DLElevation = 2
#   b <- finaldata %>% 
#     select(Filenames_filename, Data_plant_id, Data_leaftype, SysObs_date, GasEx_gsw) %>% 
#     filter(Data_leaftype == "Treatment", Data_plant_id == 2) %>%
#     group_by(Filenames_filename) %>% 
#     mutate(N2 = median(GasEx_gsw, na.rm = TRUE)) %>%
#     ungroup()
#   
#   b <- finaldata[,c("Filenames_filename", "Data_plant_id", "Data_leaftype", "SysObs_date", "GasEx_gsw")] %>%
#     group_by( Filenames_filename) %>%
#     mutate(N2 = median(GasEx_gsw, na.rm = TRUE)) #%>%
#     # ungroup()
# 
# source(here("LICOR_LOGS_functions.R"))
# b <- graph_leaf_ci(DLData = finaldata, DLElevation = 2, DLType = "Treatment", LCVar = "GasEx_A") 
# c <- graph_leaf_ci(DLData = finaldata, DLElevation = 2, DLType = "Treatment", LCVar = "GasEx_gsw") 
# 
# b/c
...
t1
ggsave(here(FIGSTORAGE,'treatment_median_lvl2_GasEx_A_ci.jpg'))#, width=3, height=6, units='in')
# ggsave('treatment_median_lvl2_GasEx_VPDleaf_ci.jpg')#, width=3, height=6, units='in')
...
t2
ggsave(here(FIGSTORAGE,'treatment_median_lvl2_GasEx_gsw_ci.jpg'))#, width=3, height=6, units='in')

t1/t2
ggsave(here(FIGSTORAGE,'treatment_median_lvl2_GasEx_A_vs_gsw_ci.jpg'))#, width=3, height=6, units='in')
...
c1
ggsave(here(FIGSTORAGE, 'control_median_lvl2_GasEx_A_ci.jpg')) #, width=3, height=6, units='in')
...
c2
ggsave(here(FIGSTORAGE, 'control_median_lvl2_GasEx_gsw_ci.jpg'))#, width=3, height=6, units='in')


c1/c2
ggsave(here(FIGSTORAGE, 'control_median_lvl2_GasEx_A_vs_gsw_ci.jpg'))#, width=3, height=6, units='in')
...
r2
ggsave(here(FIGSTORAGE, 'reference_median_lvl2_GasEx_gsw_ci.jpg')) #, width=3, height=6, units='in')

r1/r2
ggsave(here(FIGSTORAGE, 'reference_median_lvl2_GasEx_A_vs_gsw_ci.jpg')) #, width=3, height=6, units='in')

t1/c1/r1
ggsave(here(FIGSTORAGE, 'all_median_lvl2_GasEx_A_ci.jpg'), width=8, height=10, units='in')

t2/c2/r2
ggsave('all_median_lvl2_GasEx_gsw_ci.jpg', width=8, height=10, units='in')
```
