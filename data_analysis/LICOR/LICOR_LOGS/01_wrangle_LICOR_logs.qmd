...
main <- function(LogFileName) {
  ...
  # this is now a function and called multiple times to process all logs
  # LogFileName <- "2024-02-14-1115_logdata_ca_heat_lvl2"
  OutFile <- paste(DATARAW, LogFileName, sep = '')

  output <- load_data_chunks(OutFile, LogFileName)
...
FileList <- list.files("data_raw", pattern = "^[0-9]{4}-[0-9]{2}-[0-9]{2}")

main(FileList[1])

for (FileName in FileList) {
  # FileName <- paste(here("data_raw", FileName, sep = ""))
  print(FileName)
  main(FileName)
}
```
