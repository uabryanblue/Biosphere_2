...
output <- load_data_chunks(here("data_raw/2023-11-29-1226_logdata-base-level3"))
...
final_data['data_remarks'][final_data['data_remarks'] == '12:55:04 ev3ref, 12:55:05 ev3ref'] <- 'Reference'
final_data['data_remarks'][final_data['data_remarks'] == '12:49:09 ev3control, 12:49:10 ev3control'] <- 'Control'
final_data['data_remarks'][final_data['data_remarks'] == '12:27:15 ev3ref, 12:27:16 ev3ref, 12:38:43 ev3Treat..., 12:38:44 ev3Treat..., 12:38:47 ev3Treat..., 12:38:48 ev3Treat...'] <- 'Treatment'
# 11:34:16 lvl2_trt

ggplot(final_data, aes(x = data_remarks , y = GasEx_gsw, color = data_remarks)) + 
  geom_boxplot(outlier.colour="red",
                outlier.size=4) +
  ggtitle("LICOR GasEx gsw - 2023-11-29-1226_logdata-base-level3") +
    xlab("Leaf") +
    ylab("GasEx_gsw") 
...
ggplot(final_data, aes(x = data_remarks , y = GasEx_VPDleaf, color = data_remarks)) + 
  geom_boxplot(outlier.colour="red",
                outlier.size=4) +
  ggtitle("LICOR GasEx VPDleaf - 2023-11-29-1226_logdata-base-level3") +
    xlab("Leaf") +
    ylab("GasEx_VPDleaf") 
