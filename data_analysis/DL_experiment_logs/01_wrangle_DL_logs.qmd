...
Data from the warming device's five thermocouples placed on the warmed leaf and the warming pad that is controlled, the non-warmed leaf and the warming pad that is not controlled, and the reference leaf.  
...
ggsave(here("figures", "TC_boxplot_lvl2_nov_1-2023_mar_3-2024.jpg"), plot = last_plot(), width = 8, height = 6)
