...
CJ1 - Cold Junction on interface chip within the RTC box. Since the cold junction of the circuit boards were within the TRC box their temperature fluctuated with the inside temperature although it is not a value of the temperature of in box conditions.
